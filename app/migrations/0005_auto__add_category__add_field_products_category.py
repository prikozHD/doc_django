...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_products', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('app_products', 'category_id')
